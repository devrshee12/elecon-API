...
const {createGrievance, getAllGrievanceForEmp,getCountOfGrievanceOfHOD, escalateGrievance, remindGrievance, resendGrievance,getPrintData, getAllGrievance,getCountOfGrievanceOfEmp, resolvedAnalysis, getDataForActivityGrievance, countOfAllGrievance, countOfEmpGrievance, updateGrievance, getSpecificGrievance ,updateStatus, deleteGrievance, getAllGrievanceForHOD} = require("../controllers/grievance");
